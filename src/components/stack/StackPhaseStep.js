...
export const shiftImages = {
  ...
  bodyDark: require('../../assets/images/core4/icons/body-dark.png'),
  beingDark: require('../../assets/images/core4/icons/being-dark.png'),
  balanceDark: require('../../assets/images/core4/icons/balance-dark.png'),
  businessDark: require('../../assets/images/core4/icons/business-dark.png'),
};
      ...
      <View style={[gstyles.container, styles.container, styles.fieldContainer]}>
        ...
        { phaseId === 'shift' && data.id === 'meStory' && (
          <StackPhaseStepFieldBubbleContent noBubble={true}>
            ...
            <View style={[gstyles.container, gstyles.flexRow, styles.container, styles.fieldShiftImageLabelContainer]}>
              <Image style={styles.fieldShiftImage} source={shiftImages.originalBlock} />
              <Text style={styles.fieldLabelBubble}>{stack.status.drift.story}</Text>
            </View>
          </StackPhaseStepFieldBubbleContent>
        ) }
        { phaseId === 'shift' && data.id === 'meEvidence' && (
          <StackPhaseStepFieldBubbleContent noBubble={true}>
            ...
            <View style={[gstyles.container, gstyles.flexRow, styles.container, styles.fieldShiftImageLabelContainer]}>
              <Image style={styles.fieldShiftImage} source={shiftImages.me} />
        ...
        { phaseId === 'shift' && data.id === 'oppositeEvidence' && (
          <StackPhaseStepFieldBubbleContent noBubble={true}>
            ...
            <View style={[gstyles.container, gstyles.flexRow, styles.container, styles.fieldShiftImageLabelContainer]}>
              <Image style={styles.fieldShiftImage} source={shiftImages.opposite} />
        ...
        { phaseId === 'shift' && data.id === 'desiredEvidence' && (
          <StackPhaseStepFieldBubbleContent noBubble={true}>
            ...
            <View style={[gstyles.container, gstyles.flexRow, styles.container, styles.fieldShiftImageLabelContainer]}>
              <Image style={styles.fieldShiftImage} source={shiftImages.desired} />
        ...
        { phaseId === 'lift' && data.id === 'why' && (
          <StackPhaseStepFieldBubbleContent noBubble={true}>
            ...
            <View style={[gstyles.container, gstyles.flexRow, styles.container, styles.fieldShiftImageLabelContainer]}>
              <Image style={styles.fieldShiftImage} source={shiftImages.trigger} />
        ...
        { phaseId === 'lift' && data.id === 'what' && (
          [
            ...
            <StackPhaseStepFieldBubbleContent noBubble={true} key={1}>
              ...
              <View style={[gstyles.container, gstyles.flexRow, styles.container, styles.fieldShiftImageLabelContainer]}>
                <Image style={styles.fieldShiftImage} source={shiftImages.positive} />
        ...
        { phaseId === 'lift' && (data.id === 'body' || data.id === 'being' || data.id === 'balance' || data.id === 'business') && (
          <StackPhaseStepFieldBubbleContent noBubble={true}>
            ...
            <View style={[gstyles.container, gstyles.flexRow, styles.container, styles.fieldShiftImageLabelContainer]}>
              <Image style={styles.fieldShiftImage} source={shiftImages.lesson} />
        ...
        { phaseId === 'light' && (data.id === 'why' || data.id === 'action') && (
          <StackPhaseStepFieldBubbleContent noBubble={true}>
            ...
            <View style={[gstyles.container, gstyles.flexRow, styles.container, styles.fieldShiftImageLabelContainer]}>
              <Image style={styles.fieldShiftImage} source={shiftImages.revelation} />
        ...
        { phaseId === 'light' && (data.id === 'must' || data.id === 'how') && (
          <StackPhaseStepFieldBubbleContent noBubble={true}>
            ...
            <View style={[gstyles.container, gstyles.flexRow, styles.container, styles.fieldShiftImageLabelContainer]}>
              <Image style={styles.fieldShiftImage} source={shiftImages.action} />
        ...
        { phaseId === 'lift' && data.id === 'body' && !!stack.status.lift.body && (
          <StackPhaseStepFieldBubbleContent noBubble={true}>
            <Image style={styles.fieldShiftImage} source={shiftImages.bodyDark} />
          </StackPhaseStepFieldBubbleContent>
        ) }
        { phaseId === 'lift' && data.id === 'being' && !!stack.status.lift.being && (
          <StackPhaseStepFieldBubbleContent noBubble={true}>
            <Image style={styles.fieldShiftImage} source={shiftImages.beingDark} />
          </StackPhaseStepFieldBubbleContent>
        ) }
        { phaseId === 'lift' && data.id === 'balance' && !!stack.status.lift.balance && (
          <StackPhaseStepFieldBubbleContent noBubble={true}>
            <Image style={styles.fieldShiftImage} source={shiftImages.balanceDark} />
          </StackPhaseStepFieldBubbleContent>
        ) }
        { phaseId === 'lift' && data.id === 'business' && !!stack.status.lift.business && (
          <StackPhaseStepFieldBubbleContent noBubble={true}>
            <Image style={styles.fieldShiftImage} source={shiftImages.businessDark} />
          </StackPhaseStepFieldBubbleContent>
        ) }
      </View>
    );
...
class StackPhaseStep extends React.Component {
  ...
  constructor(props) {
    ...
    this.data = StackPhaseData.data[props.phaseInd].steps[props.stack.currentStep];
  }
    ...
    return (
      <View style={[gstyles.container, styles.container, styles.stepContainer]}>
        <View style={[gstyles.container, styles.container, styles.fieldsContainer]}>
          {
            this.data.fields.map((field, ind) => <StackPhaseStepField key={field.id} phaseInd={this.props.phaseInd} stepInd={this.props.stepInd} fieldInd={ind} data={field} stack={this.props.stack} updateChoice={(val) => this.props.updateChoice(val)} />)
          }
        </View>
      </View>
    );
